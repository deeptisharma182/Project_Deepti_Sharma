...
import accLogo from '../utils/images/accountLogo.png'
import bellIcon from '../utils/images/bellIcon.png'
import dropdown from '../utils/images/drop-down-menu.png'
import icon1 from '../utils/images/Logo1.png'
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img className='w-32' src={icon1} alt="Logo" />
              </div>
            ...
            <div className="ml-4">
              ...
              {/* Bell Image */}
              <div className="mr-2">
                <img className="w-10 h-10 " src={bellIcon} alt="bell" />
              </div>


              {/* Account Image */}
              <div className="">
                <img className="w-8 h-8 " src={accLogo} alt="User Avatar" />
              </div>
